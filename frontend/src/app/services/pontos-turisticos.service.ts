...
export class PontosTuristicosService {
  ...
  */
  ...
  getBuscarPontosTuristicos(pontoTuristico: string){
    const busca = '?search=' + pontoTuristico;

    return this.http.get(this.url + this.urlPontoTuristico + busca);
  }
  ...
  postPontoTuriscticoCompleto(pontoTuristicoDados: any, atracaoDados: any, comentariosDados: any, avaliacoesDados: any, enderecoDados: any): Observable<any> {
    const pontoTuristico = {nome: pontoTuristicoDados.nome, descricao: pontoTuristicoDados.descricao, aprovado: pontoTuristicoDados.aprovado};
    const atracoes = {nome: atracaoDados.nome, descricao: atracaoDados.descricao, horario_fun: atracaoDados.horario_fun, idade_minima:atracaoDados.idade_minima};
